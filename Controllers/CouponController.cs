...
namespace WebMVC.Controllers
{
    public class CouponController : Controller
    {
        ...
        {
            // Retrive all the cupons and pass to the view
        ...
        public async Task<IActionResult> Create(Coupon coupons)
        {
            ...
            {
                //Get the files, convert to a byte to save to database
        ...
        {
            var coupons = await _db.Coupon.FirstOrDefaultAsync(m => m.Id == id);
